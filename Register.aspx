...
<head id="Head1" runat="server">
    ...
    <script src="RegMultiple/script.js"></script>
    <script language="javascript">
        ...
        function btnClick(action) {
            ...
            if (action == 2) {
                ...
                //$.ajax({
                //    url: "Register.aspx/SendClientForm",
                //    type: "POST",
                //    dataType: "json",
                //    data: "{}",
...
<body>
    <form id="Form1" runat="server">
        ...
        <div align="center">
            <div id="" class="dvRoundAndBgForReg">
                <div class="">
                    ...
                    <div class="">
                        <div style="float: left">
                            ...
                            <br />
                            <span style="color: #025482; font-size: 23px;">This page is created for "company name" experts for B1 work permit.<br />
                            ...
                            <tr>
                                <td>
                                    <div>
                                        ...
                                        <asp:TextBox ID="txtPassport" CssClass="txtRegister" runat="server" Width="240" Height="25" />
                        ...
                        <div id="dvFamaly" style="display: none">
                            ...
                            <div>
                                <table width="100%" class="tblFamaly">
                                    <tr>
                                        <td class="tdFamHeader">Family name
                                        </td>
                                        <td class="tdFamHeader">Given name
                                        </td>
                                        <td class="tdFamHeader">Maiden name
                                        </td>
                                        <td class="tdFamHeader">Father’s name

                                        </td>
                                        <td class="tdFamHeader">Place of Birth
                            ...
                            <div>
                                <table width="80%" class="tblFamaly">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdFamData">
                                            <asp:TextBox ID="txtChild1DateofBirth" CssClass="txtFamely" runat="server" />
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdFamData">
                                            <asp:TextBox ID="txtChild2DateofBirth" CssClass="txtFamely" runat="server" />
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdFamData">
                                            <asp:TextBox ID="txtChild3DateofBirth" CssClass="txtFamely" runat="server" />
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdFamData">
                                            <asp:TextBox ID="txtChild4DateofBirth" CssClass="txtFamely" runat="server" />
                                        </td>
                    ...
                    <div id="dvfooter" class="dvNavigate">
                        ...
                        <input type="button" id="btnAction2" class="buttBlue" runat="server" value="Send Form" onclick="btnClick(2);" onserverclick="SendClientForm"  />
