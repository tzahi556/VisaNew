...
(function ($, window, document) {
  ...
  function _openDropdown($dk) {
    ...
    var actualTop = $dk.find('.dk_options').offset().top;
    var outerHeight = $dk.find('.dk_options').outerHeight(); 
    
    if(actualTop + outerHeight > $(window).outerHeight() - 40) {
	    
		$dk.find('.dk_options').css({ top : -outerHeight });
    }
  }
