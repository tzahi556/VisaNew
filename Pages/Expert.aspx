                    ...
                    <table width="100%" border="0">
                        <tr>
                            ...
                            <td style="font-size: 14px;" align=left>
                                <asp:TextBox ID="txtSurname" runat="server" Width="150" AutoPostBack="true" OnTextChanged="txt_TextChanged"
                            ...
                            <td align="left" style="font-size: 14px;" align="left">
                                <asp:TextBox ID="txtName" runat="server" AutoPostBack="true" Width="150" OnTextChanged="txt_TextChanged"
                                    Style="font-size: 14px; "></asp:TextBox>
                            </td>
            ...
            <div id="tabs" runat="server">
                ...
                <div id="tabs-1">
                    <div class="dvTabContent">
                                            ...
                                            <Columns>
                                             ...
                                             <asp:BoundField DataField="LevelId"  HeaderText="Level" SortExpression="LevelId">
                                              <ItemStyle Font-Bold="True" BorderWidth="1" />
                                                ...
                                                <asp:BoundField DataField="Approval From Date" HeaderText="Approval From Date" SortExpression="AFDate">
                                                </asp:BoundField>
                                                ...
                                                <asp:BoundField DataField="Visa Exp Date" HeaderText=" Visa Exp Date" SortExpression="VEDate">
                                                </asp:BoundField>
                                                <asp:BoundField DataField="Multiple entry Visa" HeaderText="Re Entry Visa Exp" SortExpression="MEVDate">
                                                </asp:BoundField>
                                            </Columns>
                                        </asp:GridView>
                                    </contenttemplate>
                            ...
                            <div style="float: left;">
                                <table cellpadding="0">
                                    <tr>
                                        ...
                                        <td class="redButton">
                                            <button id="btnDelete" type="button" runat="server" onclick="DeleteCustomer();" style="font-size: 14px;
                                                height: 30px">
                                                Delete Selected
                                            </button>
                                        </td>
                        ...
                        <div id="dvTheGridProgress" style="position: absolute; background: white; left: 0px;
                ...
                <div id="tabs-2">
                    <div class="dvTabContent">
                        ...
                        <div id="dvArchiveProgress" style="position: absolute; background: white; left: 0px;
                            top: 0px; right: 0px; bottom: 0px">
                            <div style="position: absolute; top: 50%; left: 50%; margin-top: -16px; margin-left: -32px;">
                                <img src="../App_Themes/Theme1/Images/ajax-loader.gif" width="32px" height="32px" />
                            </div>
                ...
                <div id="tabs-3">
                    <div class="dvTabContent">
                        ...
                        <div id="dvDocsProgress" style="position: absolute; background: white; left: 0px;
                            top: 0px; right: 0px; bottom: 0px">
                            <div style="position: absolute; top: 50%; left: 50%; margin-top: -16px; margin-left: -32px;">
                                <img src="../App_Themes/Theme1/Images/ajax-loader.gif" width="32px" height="32px" />
                            </div>
