<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeFile="Report.aspx.cs"
                ...
                <tr>
                    ...
                    <td valign="top" align="center" style="width: 22%">
                        ...
                        <table border="0" width="100%" cellspacing="5" class="tbRow">
                            ...
                            <tr>
                                <td valign="bottom" colspan="2" style="background: transparent;height:35px;">
                            ...
                            <tr>
                                ...
                                <td align="left"  style="background: transparent;height:25px;padding:0px">
                                  Fr' <asp:TextBox ID="txtFrom" runat="server" CssClass="txtCalander" Style="width: 58px"></asp:TextBox>
                                     </td>
                                <td align="left"  style="background: transparent;height:25px;padding:0px">
                                    
                                     To <asp:TextBox ID="txtTo" runat="server" CssClass="txtCalander" Style="width: 58px"></asp:TextBox>
                                </td>
